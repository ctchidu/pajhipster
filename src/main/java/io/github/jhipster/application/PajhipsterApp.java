...
public class PajhipsterApp {

    private static final Logger log = LoggerFactory.getLogger(PajhipsterApp.class);

    private final Environment env;

    public PajhipsterApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes pajhipster.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PajhipsterApp.class);
